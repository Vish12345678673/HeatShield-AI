  ...
  head: () => ({
    meta: [
      ...
      },
      {
        name: "description",
        content:
          "Protect workers before exposure becomes dangerous — safe work windows, mandatory breaks and hydration guidance.",
      },
      {
        property: "og:title",
        content: "Worker Heat Safety — HeatShield AI",
      },
      {
        property: "og:description",
        content:
          "Protect workers before exposure becomes dangerous.",
      },
    ],
  }),
...
function WorkerPage() {
  ...
  /*
   * useLiveReading currently accepts an optional
   * refresh interval number, not a Metro object.
   */
  const { reading, status } = useLiveReading(metro);

  const guidance = useMemo(
    () => workerGuidance(reading),
    [reading],
  );
  ...
  const cards: {
    ...
    {
      icon: CalendarClock,
      label: "Recommended Work Window",
      value: guidance.workWindow,
      sub: "Lowest thermal load today",
      tone: "mint",
    },

    {
      ...
      value: `Every ${guidance.breakEveryMin} minutes`,
      sub: "Shaded recovery, 10 min minimum",
      tone: "amber",
    },

    {
      ...
      value: guidance.avoidWindow,
      sub: "Peak solar + heat index overlap",
      tone: "high",
    },

    {
      icon: Droplets,
      label: "Hydration",
      value: guidance.hydration,
      sub: "250ml every 20 minutes",
      tone: "cyan",
    },

    {
      ...
      value: guidance.nextSafeWindow,
      sub: "Risk drops below moderate",
      tone: "lavender",
    },
  ];
  ...
  return (
    <div className="space-y-5">
      <PageHeader
        ...
        right={
          <div className="flex items-center gap-3">
            <ToneBadge tone={guidance.tone}>
              OUTDOOR WORK · {guidance.riskLabel}
            </ToneBadge>
      ...
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-[1fr_280px]">
        <ChartCard
          title="Heat Safety Timeline"
          subtitle="Safe → Caution → Dangerous → Extreme → Safe · today"
          live
        >
          <SafetyTimeline
            segments={guidance.timeline}
            className="py-2"
          />
